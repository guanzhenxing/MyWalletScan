...
function Linea() {
    ...
    const handleChangeApiOk = () => {
        ...
        setApiKey(localStorage.getItem('linea_api_key'));
    }
    useEffect(() => {
        ...
        try {
            ...
            for (let key of selectedKeys) {
                ...
                if (index !== -1) {
                    ...
                    promisesQueue.push(() => {
                        item.linea_eth_balance = null;
                        return getLineaInfo(item.address, apiKey).then(({balance}) => {
                    ...
                    promisesQueue.push(() => {
                        item.linea_tx_amount = null;
                        item.linea_last_tx = null;
    ...
    const handleDelete = (key) => {
        ...
        localStorage.setItem('linea_addresses', JSON.stringify(data.filter(item => item.key !== key)));
    }
    ...
    const columns = [
        ...
        },
        {
            ...
            children: [
                ...
                // {
                //     title: "USDT",
                //     dataIndex: "linea_usdtBalance",
                //     key: "linea_usdtBalance",
                //     align: "center",
                //     render: (text, record) => (text === null ? <Spin/> : text),
                //     width: 80
                // },
                    ...
                    },
                {
                    ...
                    sorter: (a, b) => {
                        const parseTimeString = (str) => {
                          ...
                          const timeA = parseTimeString(a.linea_last_tx);
                          const timeB = parseTimeString(b.linea_last_tx);
                ...
                >
                    <Form form={changeApiForm} layout="horizontal">
                        <Form.Item label="Linea" name="linea">
                            <Input placeholder="请输入Lineascan API Key"/>
                        </Form.Item>
                    </Form>
                </Modal>
